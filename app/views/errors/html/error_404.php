...
<head> 
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?=base_url().get_option('website_favicon', BASE."assets/images/favicon.png")?>">
...
<body>
        ...
        <div class="container">
            <img src="<?=BASE.get_option('website_logo')?>" class="logo" style="max-width: 200px;height: auto;">
            <div class="content">
                <p>404😢</p>
