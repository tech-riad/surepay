...
class Tickets_model extends MY_Model
{
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            ...
            if ($params['filter']['status'] != 'all' && in_array($params['filter']['status'], $this->filter_accepted)) {
                $this->db->where('tk.status', $params['filter']['status']);
            }
            //Search
    ...
    public function get_item($params = null, $option = null)
    {
        ...
        if($option['task'] == 'get-item-update'){
            $result = $this->get("*", $this->tb_ticket_message, ['ids' => $params['ids']], '', '', true);
        }
    ...
    public function count_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'count-items-group-by-status') {
            ...
            $query = $this->db->get();
            $result = $query->result_array();
        }elseif ($option['task'] == 'count-items-for-pagination') {
    ...
    public function save_item($params = null, $option = null)
    {
        switch ($option['task']) {
            case 'edit-item-ticket-massage':
                ...
                $this->db->update($this->tb_ticket_message, $data_item_ticket_message, ['ids' => post('ids')]);
