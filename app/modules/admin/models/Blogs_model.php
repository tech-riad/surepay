...
class Blogs_model extends MY_Model 
{
    ...
    public function __construct()
    {
        ...
        $this->field_search_accepted = app_config('config')['search']['blogs'];
    }
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            $this->db->select('id,title, description, status, created');
        ...
        if ($option['task'] == 'list-items-view-blogs') {
            $this->db->select('id,title, description, status, created');
            $this->db->from($this->tb_main);
    ...
    public function get_item($params = null, $option = null)
    {
        ...
        if($option['task'] == 'get-item'){
            $result = $this->get("id,title, description, status, created", $this->tb_main, ['id' => $params['id']], '', '', true);
        }
        return $result;
    }
