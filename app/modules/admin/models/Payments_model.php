...
class Payments_model extends MY_Model 
{
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            $this->db->select('id, type, name, sort,status,params');
        ...
        // List active in Users
        if ($option['task'] == 'admin-active-list-items') {
            $this->db->where('id!=1');
            $result = $this->fetch("id, type, sort, name", $this->tb_main, ['status' => 1], 'sort', 'asc', true);
        }

        // List pm on PM bonuses
        if ($option['task'] == 'admin-list-items-on-pm-bonuses') {
    ...
    public function get_item($params = null, $option = null)
    {
        ...
        if($option['task'] == 'get-item'){
            $result = $this->get("id, type, name,sort, params, status", $this->tb_main, ['id' => $params['id']], '', '', true);
        }
