        ...
        <div class="card">
            ...
            <?php echo form_open($form_url, $form_attributes, $form_hidden); ?>
                <div class="form-group">
                    ...
                    <textarea rows="10" class="form-control plugin_editor" name="message"></textarea>
                </div>
                <button type="submit" class="btn btn-info btn-min-width m-3 float-end">Submit</button>
