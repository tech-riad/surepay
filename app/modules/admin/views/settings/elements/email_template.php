    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          ...
          <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("email_verification_for_new_user_accounts")?></h5>
          ...
          <div class="form-group">
            <div class="small">
              ...
              <ul>
                ...
                <li>{{user_lastname}} - <?=lang("displays_the_users_last_name")?></li>
                <li>{{user_email}} - <?=lang("displays_the_users_email")?></li>
                <li>{{pay_amount}} - <?=lang("displays_payment_amount")?></li>
              </ul>
            </div>
          </div>
...
<div class="card">
  ...
  <div class="card-body">
      <h5 class="text-info"><i class="fe fe-link"></i> <?=lang("Send mail to all user")?></h5 class="text-info">
    ...
    <div class="form-group">
      <div class="small">
        ...
        <ul>
          <li>{{user_firstname}} - <?=lang("displays_the_users_first_name")?></li>
          <li>{{user_lastname}} - <?=lang("displays_the_users_last_name")?></li>
          <li>{{email}} - <?=lang("displays_the_users_email")?></li>
          <li>{{balance}} - <?=lang("displays_the_users_balance")?></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="card-footer text-end">
      <button class="btn btn-primary btn-min-width text-uppercase"><?=lang("Send mail")?></button>
    </div>
  <?php echo form_close(); ?>
