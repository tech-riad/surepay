<?php
  ...
  $general_elements = [
    ...
    [
      'label'      => form_label('BRAC Bank Account Name'),
    ...
    [
      'label'      => form_label('BRAC Bank Account Number'),
    ...
    [
      'label'      => form_label('BRAC Bank Branch Name'),
    ...
    [
      'label'      => form_label('BRAC Bank Routing Number'),
...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?=lang("BRAC Bank Setup")?></h3>
  </div>
  <div class="card-body">
    <div class="row">
