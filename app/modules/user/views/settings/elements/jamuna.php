<?php
  ...
  $general_elements = [
    ...
    [
      'label'      => form_label('Jamuna Bank Account Name'),
    ...
    [
      'label'      => form_label('Jamuna Bank Account Number'),
    ...
    [
      'label'      => form_label('Jamuna Bank Branch Name'),
    ...
    [
      'label'      => form_label('Jamuna Bank Routing Number'),
...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?=lang("Jamuna Bank Setup")?></h3>
  </div>
  <div class="card-body">
    <div class="row">
