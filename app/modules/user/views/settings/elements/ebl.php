<?php
  ...
  $general_elements = [
    ...
    [
      'label'      => form_label('EBL Account Name'),
    ...
    [
      'label'      => form_label('EBL Account Number'),
    ...
    [
      'label'      => form_label('EBL Branch Name'),
    ...
    [
      'label'      => form_label('EBL Routing Number'),
...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?=lang("EBL Bank Setup")?></h3>
  </div>
  <div class="card-body">
    <div class="row">
