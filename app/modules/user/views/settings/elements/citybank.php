<?php
  ...
  $general_elements = [
    ...
    [
      'label'      => form_label('CITY BANK Account Name'),
    ...
    [
      'label'      => form_label('CITY BANK Account Number'),
    ...
    [
      'label'      => form_label('CITY BANK Branch Name'),
    ...
    [
      'label'      => form_label('CITY BANK Routing Number'),
...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?=lang("CITY BANK Setup")?></h3>
  </div>
  <div class="card-body">
    <div class="row">
