<?php
  ...
  $general_elements = [
    ...
    [
      'label'      => form_label('DBBL Account Name'),
    ...
    [
      'label'      => form_label('DBBL Account Number'),
    ...
    [
      'label'      => form_label('DBBL Branch Name'),
    ...
    [
      'label'      => form_label('DBBL Routing Number'),
...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?=lang("DBBL Bank Setup")?></h3>
  </div>
  <div class="card-body">
    <div class="row">
