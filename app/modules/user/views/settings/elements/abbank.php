<?php
  ...
  $general_elements = [
    ...
    [
      'label'      => form_label('AB BANK Account Name'),
    ...
    [
      'label'      => form_label('AB BANK Account Number'),
    ...
    [
      'label'      => form_label('AB BANK Branch Name'),
    ...
    [
      'label'      => form_label('AB BANK Routing Number'),
...
<div class="card content">
  <div class="card-header">
    <h3 class="card-title"><i class="fe fe-sliders"></i> <?=lang("AB BANK Setup")?></h3>
  </div>
  <div class="card-body">
    <div class="row">
