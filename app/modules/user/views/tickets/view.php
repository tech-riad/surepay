...
<div class="row">
    ...
    <?php
        $form_url     = cn('user/'.$controller_name."/store_message/");
        $redirect_url = cn('user/'.$controller_name . '/view/') . $item['id'];
        ...
        <div class="card">
            ...
            ?>
                <?php echo form_open($form_url, $form_attributes, $form_hidden); ?>
                    ...
                    <button type="submit" class="btn btn-primary btn-min-width mt-1 float-end"><?=lang("Submit")?></button>
                <?php echo form_close(); ?>
                <hr/>   
            <?php } ?>
            <div id="frame">
