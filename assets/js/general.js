...
function General(){
    ...
    this.General = function() {
        ...
        function get_notification(type='',id=''){
          $.post($('.notification_open').attr('data-url'),{token: token,type:type,id:id},function(_result){
                setTimeout(function () {
        ...
        $(document).on("click", ".notification_all,.notification_single" , function(){
        ...
        { 
            ...
            let type= $('.total_notification').attr('data-type');
            if (type) {
            $.post($('.total_notification').attr('data-url'),{token: token,type:type},function(_result){
                _result = JSON.parse(_result);
                if (_result.notification_count) {$('.total_notification').html(_result.notification_count)}
                if (_result.tickets_count) {$('.total_unread_tickets').html(_result.tickets_count)}
                if (_result.kyc_count) {$('.total_unread_kyc').html(_result.kyc_count)}
            });}
