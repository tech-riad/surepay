<style> :root {--bg1: #1E42A0; --bg2: #E0EDEB; } .bg1 {background-color: var(--bg1); } .bg2 {background-color: var(--bg2); color: var(--bg1); } .bg2-t {letter-spacing: -1px; color: var(--bg1); } input::placeholder {color: var(--bg1); } #transaction_id,#payment_slip{display: none; } .bank-pay{padding: 15px; margin: 12px; margin-bottom: 0; max-height: 80px; max-width: 100%; } .bank-pay .input{position: relative; padding: 4px; border-radius: 15px; background: #ffffff; max-height: 25px; overflow: hidden; } .bank-pay label{margin-left: 25%; } .bank-pay label:before {position: absolute; top: 0; left: 0; bottom: 0; content: "Choose File"; background: #f2f4f6; padding: 2px; border-radius: 10px; } .method-text p{border: none; } .method-text div{font-family: "bangla",sans-serif;border-bottom: 1px solid #00000014; margin-top: 15px; padding-bottom: 5px; } 
</style> 
