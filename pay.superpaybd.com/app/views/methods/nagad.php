<style> :root {--bg1: #C90008; --bg2: #FFCDD2; } .bg1 {background-color: var(--bg1); } .bg2 {background-color: var(--bg2); color: var(--bg1); } .bg2-t {letter-spacing: -1px; color: var(--bg1); } input::placeholder {color: var(--bg1); } </style>
...
<div class="method-text">
 <p>
   *167# ডায়াল করে আপনার NAGAD মোবাইল মেনুতে অথবা NAGAD অ্যাপে যান।
 </p>
 ...
 <p>নিশ্চিত করতে আপনার NAGAD পিন লিখুন</p>
</div>
