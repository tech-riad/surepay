...
<html lang="en">
  ...
  <body>
    <div class="container-m">
      ...
      <div class="image">
        <img src="<?=base_url('assets/images/failed.png')?>" alt="Failed" />
      </div>
      ...
      <div class="bottom"><a href="<?php echo $temp_failed_url ?>">ওয়েবসাইটে ফিরে যান</a></div>
    </div>
    ...
    <script>
      ...
      var downloadTimer = setInterval(function () {
        if (timeleft <= 0) {
          ...
          location.href = "<?php echo $temp_failed_url ?>";
        } else {
